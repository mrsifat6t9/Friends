...
os.system("espeak -a 300 \"UPDATE VERSION 0.0V,\"")
time.sleep(2)
#os.system('clear')
...
time.sleep(2)
os.system(f'xdg-open https://youtube.com/@VersionX6T9?si=irkPLCXXdR2Jg8Ed)
os.system(f'xdg-open https://facebook.com/groups/3760213190928657/)
ugen2=[]
ugen=[]
cokbrut=[]
